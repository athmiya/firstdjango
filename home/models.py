...
# class member(models.Model):
  #  member_name = models.CharField(max_length=100, help_text='Name of Author',null=True)
   # date_of_purchase = models.DateField('Purchased On',null=True, blank=True)
  #  date_of_returning = models.DateField('Returning On',null=True, blank=True)
  #  def __str__(self):
